...
class LabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lab" do
    assert_difference('Lab.count') do
      post labs_url, params: { lab: { chief_id: @lab.chief_id, description: @lab.description, name: @lab.name } }
    end
  ...
  test "should update lab" do
    patch lab_url(@lab), params: { lab: { chief_id: @lab.chief_id, description: @lab.description, name: @lab.name } }
